...
tp_dado_arquivos = {
     ...
     'portos': {'NOME_PORTO_VCM':str,'NOME_AZ_PORTO_VCM':str,'PORTO':str,'UNIDADE':str,'UNIDADE_SAP':str,'CORRENTE':str},
     'portos_correntes':{'NOME_PORTO_VCM':str,'PORTO':str,'UNIDADE':str,'UNIDADE_SAP':str,'CORRENTE':str},
     ...
     'unidades_exp': {'DEPOSITO':'str','PLANTA':str, 'DESCRICAO_DEPOSITO':str, 'DESCRICAO_PLANTA':str, 'TIPO_UNIDADE':str,
                      'UNIDADE_ARMAZENAGEM_VCM':str,'UP_MISTURADORA_VCM':str,'UNIDADE_EXPEDICAO_VCM':str, 'NOME_UNIDADE_LIMITES':str},
